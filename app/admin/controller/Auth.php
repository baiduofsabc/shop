...
class Auth extends Common
{
    ...
    public function adminAdd(){
        if(request()->isPost()){
            ...
            $this->assign('selected_hospital', 'null');
    ...
    public function adminEdit(){
        if(request()->isPost()){
            ...
            // $selected_hospital = db('hospital')->where('id',$info['hospital_id'])->find();
            
            $this->assign('selected',json_encode($selected,true));
            // $this->assign('selected_hospital',json_encode($selected_hospital,true));s
