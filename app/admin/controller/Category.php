    ...
    public function index()
    {
        if ($this->categorys) {
            foreach ($this->categorys as $r) {
                ...
                if ($r['parentid'] == 0) {
                    $r['str_manage'] = '<a class="blue" title="添加子栏目" href="' . url('Category/add', array('parentid' => $r['id'])) . '"> <i class="icon icon-plus"></i></a> |';
                }
                $r['str_manage'] .= ' <a class="green" href="' . url('Category/edit', array('id' => $r['id'])) . '" title="修改"><i class="icon icon-pencil2"></i></a> | <a class="red" href="javascript:del(\'' . $r['id'] . '\')" title="删除"><i class="icon icon-bin"></i></a> ';
            ...
            $str .= "<td class='text-left'>\$spacer<a href-data='/admin/\$module/\$action/\$files/\$id.html' class='green' title='查看内容'>\$catname </a>&nbsp;</td>";
