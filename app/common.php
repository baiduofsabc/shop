...
function sendSms($to, $code){
    require_once ROOT_PATH.'/plugins/alisms/SignatureHelper.php';
    ...
    $accessKeyId = "LTAIg2zMMjkOyY6E";
    $accessKeySecret = "I7huXQ3rM056GpOcjLIjp7DONGPtEB";

    // fixme 必填: 短信接收号码
    $params["PhoneNumbers"] = $to;

    // fixme 必填: 短信签名，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
    $params["SignName"] = "徐州百多信息科技";

    // fixme 必填: 短信模板Code，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
    $params["TemplateCode"] = "SMS_173340595";
...
function base64_image_content($base64_image_content,$path){
  ...
  if (preg_match('/^(data:\s*image\/(\w+);base64)/', $base64_image_content, $result)){
    ...
    $new_file = $new_file.time().rand(1000,9999).".{$type}";  //图片名以时间命名
    //保存为文件
