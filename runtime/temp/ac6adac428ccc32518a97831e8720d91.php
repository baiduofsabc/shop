<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:53:"E:\asd1028\fszb1027/app/admin\view\system\system.html";i:1603874470;s:51:"E:\asd1028\fszb1027\app\admin\view\common\head.html";i:1603874470;s:51:"E:\asd1028\fszb1027\app\admin\view\common\foot.html";i:1603874470;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <form class="layui-form layui-form-pane">
      ...
      <!--   <div class="layui-form-item">
        ...
        <div class="layui-form-item">
            ...
            <input type="hidden" name="ewm" id="ewm" value="<?php echo $system['ewm']; ?>">
            <div class="layui-input-block">
                <div class="layui-upload">
                    <button type="button" class="layui-btn layui-btn-primary" id="ewmBtn"><i class="icon icon-upload3"></i>点击上传</button>
                    <div class="layui-upload-list">
                        <img class="layui-upload-img" id="ewmImg">
                        <p id="ewmText"></p>
                    </div>
                </div>
            </div>
        ...
        <div class="layui-form-item">
            <label class="layui-form-label">官方客服</label>
            <input type="hidden" name="kefu" id="kefu" value="<?php echo $system['kefu']; ?>">
            <div class="layui-input-block">
                <div class="layui-upload">
                    <button type="button" class="layui-btn layui-btn-primary" id="kefuBtn"><i class="icon icon-upload3"></i>点击上传</button>
                    <div class="layui-upload-list">
                        <img class="layui-upload-img" id="kefuImg">
                        <p id="kefuText"></p>
                    </div>
                </div>
            </div>
...
<script>
    layui.use(['form', 'layer','upload'], function () {
        ...
        if("<?php echo $system['ewm']; ?>"){
            ewmImg.src = "/public"+ "<?php echo $system['ewm']; ?>";
        }
        if("<?php echo $system['kefu']; ?>"){
            kefuImg.src = "/public"+ "<?php echo $system['kefu']; ?>";
        }
        //普通图片上传
        ...
        var uploadShare = upload.render({
            elem: '#shareBtn'
            ,url: '<?php echo url("UpFiles/upload"); ?>'
            ,before: function(obj){
                //预读本地文件示例，不支持ie8
                obj.preview(function(index, file, result){
                    $('#shareImg').attr('src', result); //图片链接（base64）
                });
            }
            ,done: function(res){
                //上传成功
        ...
        var uploadewm = upload.render({
            elem: '#ewmBtn'
            ,url: '<?php echo url("UpFiles/upload"); ?>'
            ,before: function(obj){
                //预读本地文件示例，不支持ie8
                obj.preview(function(index, file, result){
                    $('#ewmImg').attr('src', result); //图片链接（base64）
                });
            }
            ,done: function(res){
                //上传成功
        ...
        var uploadkefu = upload.render({
            elem: '#kefuBtn'
            ,url: '<?php echo url("UpFiles/upload"); ?>'
            ,before: function(obj){
                //预读本地文件示例，不支持ie8
                obj.preview(function(index, file, result){
                    $('#kefuImg').attr('src', result); //图片链接（base64）
                });
            }
            ,done: function(res){
                //上传成功
